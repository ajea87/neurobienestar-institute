  ...
  return (
    <div style={{ marginBottom: '32px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
        <span style={{ color: 'rgba(244,239,230,0.55)', fontSize: '12px', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
          Tono vagal
        </span>
        <span style={{ color: '#2B7A8B', fontSize: '13px', fontWeight: 600 }}>{label}</span>
      </div>
      <div style={{ background: 'rgba(244,239,230,0.08)', borderRadius: '4px', height: '6px', overflow: 'hidden' }}>
        <div style={{
          height: '100%',
          width: `${pct}%`,
      ...
      <div style={{ textAlign: 'right', marginTop: '4px' }}>
        <span style={{ color: 'rgba(244,239,230,0.35)', fontSize: '11px' }}>{completed}/21 sesiones</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#1A2326', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ color: '#F4EFE6', fontSize: '16px', letterSpacing: '0.1em' }}>IEN</div>
          <div style={{ color: 'rgba(244,239,230,0.3)', fontSize: '9px', letterSpacing: '0.14em', textTransform: 'uppercase' }}>Protocolo 21 Días</div>
        </div>
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <Link href="/programa/progreso" style={{ color: 'rgba(244,239,230,0.5)', fontSize: '13px', textDecoration: 'none' }}>
            Mi progreso
          </Link>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          <p style={{ color: 'rgba(244,239,230,0.45)', fontSize: '12px', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 8px' }}>
            Día {totalCompleted} de 21
          </p>
          <h1 style={{ color: '#F4EFE6', fontSize: '26px', fontWeight: 400, margin: '0 0 8px', lineHeight: 1.3 }}>
            {completionMessage}
          </h1>
          {streak > 1 && (
            <p style={{ color: '#2B7A8B', fontSize: '13px', margin: 0 }}>
          ...
          <Link href={`/programa/dia/${currentNextDay}`} style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                  <div style={{ color: 'rgba(244,239,230,0.45)', fontSize: '11px', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '6px' }}>
                    Próxima sesión · Día {currentNextDay}
                  </div>
                  <h2 style={{ color: '#F4EFE6', fontSize: '20px', fontWeight: 400, margin: '0 0 6px' }}>
                    {PROGRAM_CONTENT[currentNextDay - 1]?.title}
                  </h2>
                  <p style={{ color: 'rgba(244,239,230,0.5)', fontSize: '14px', margin: 0 }}>
              ...
              <div style={{ marginTop: '16px', display: 'flex', gap: '16px' }}>
                <span style={{ color: 'rgba(244,239,230,0.35)', fontSize: '12px' }}>
        ...
        {allDone && (
          <div style={{
            background: 'linear-gradient(135deg, #1C3D50, #2B7A8B20)',
            borderRadius: '12px',
            padding: '32px',
            marginBottom: '40px',
            textAlign: 'center',
            ...
            <h2 style={{ color: '#F4EFE6', fontSize: '22px', fontWeight: 400, margin: '0 0 8px' }}>
              Programa completado
            </h2>
          ...
          return (
            <div key={wi} style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                <span style={{ color: 'rgba(244,239,230,0.5)', fontSize: '12px', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                  {weekName}
                </span>
                <span style={{ color: 'rgba(244,239,230,0.3)', fontSize: '12px' }}>{weekCompleted}/7</span>
              </div>
              <div style={{ background: 'rgba(244,239,230,0.06)', borderRadius: '3px', height: '3px', marginBottom: '16px', overflow: 'hidden' }}>
                <div style={{ height: '100%', width: `${weekPct}%`, background: '#2B7A8B', borderRadius: '3px' }} />
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '8px' }}>
                {weekDays.map((dayContent) => {
                  ...
                  return (
                    ...
                    >
                      <div style={{
                        background: isDone ? '#2B7A8B' : isNext ? '#1C3D50' : 'rgba(244,239,230,0.04)',
                        border: isNext ? '1px solid rgba(43,122,139,0.6)' : '1px solid transparent',
                        borderRadius: '8px',
                        padding: '10px 6px',
                        textAlign: 'center',
                        ...
                        <div style={{
                          color: isDone ? 'rgba(244,239,230,0.7)' : 'rgba(244,239,230,0.25)',
                          fontSize: '9px',
                          marginTop: '3px',
