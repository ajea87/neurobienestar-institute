    ...
    <div style={{ background: "#F4EFE6", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          {/* SECCIÓN 8 — GARANTÍA + PRUEBA SOCIAL */}
          <div
            style={{
            ...
            {[
              {
                ...
                text: "El PDF llega a tu email en segundos.",
              },
              {
                icon: (
                  <svg
                ...
                text: "Pago único de 7€. Sin renovaciones.",
              },
              {
                icon: (
                  <svg
                ...
                text: "Si no es lo que esperabas, te devolvemos el dinero.",
              },
            ].map((item) => (
              <div
                key={item.title}
